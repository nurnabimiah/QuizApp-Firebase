            ...
            AnimatedPositioned(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Center(child: Lottie.asset('images/animations/quizicon.json',height: 150)),
                    Padding(
                      padding: const EdgeInsets.only(left: 12.0),
                      child: Text('Quiz App',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Colors.red),),
                    ),
